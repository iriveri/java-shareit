...
public class BookingServiceIntegrationTest {
    ...
    void createBooking_ShouldCreateBooking() {
        ...
        Assertions.assertEquals(savedUser.getId(), retrievedBooking.getBooker().getId());
        Assertions.assertEquals(savedItem.getId(), retrievedBooking.getItem().getId());
    ...
    void getUserBookings_ShouldReturnBookings() {
        ...
        Assertions.assertEquals(savedUser.getId(), userBookings.get(0).getBooker().getId());
    }
    ...
    void getOwnerBookings_ShouldReturnBookings() {
        ...
        Assertions.assertEquals(savedItem.getId(), ownerBookings.get(0).getItem().getId());
    }
